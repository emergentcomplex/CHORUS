#### **Filename: `/docs/GENESIS_PROMPT.md` (Corrected)**
...
1.  **The Logos (The Constitution):** This is the `/docs/01_CONSTITUTION.md`. It contains the **22 Axioms**, the Triumvirate architecture, our quantitative quality targets, and the formal Amendment Process. It is the supreme, inviolable law of the project.
...
3.  **The Land (The Codebase):** This is the `find . -type f ! -path "./models/*" ! -path "./data/*" ! -path "./venv/*" ! -path "./.git/*" -exec cat {} +` output, representing the ground truth of the current implementation.
